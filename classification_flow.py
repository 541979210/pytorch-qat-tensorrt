...
- pipeline for cloassification model to generate tensorrt
"""
...
from models.classification.train import evaluate, train_one_epoch, load_data, utils
...
def get_parser():
    ...
    parser.add_argument('--batch-size-train', type=int, default=16, help='batch size for training: default 128')
    ...
    parser.add_argument('--num-finetune-epochs', default=4, type=int,
